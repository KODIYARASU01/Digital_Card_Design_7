...
const NewCardDesign9 = () => {
 ...
 <div className="card9_box1">
  ...
  <div className="logo">
    <img className="logo_img" src={avatar} alt="logo" />
    <div className="shape">
  ...
  <div className="user_detail">
    ...
    <div className="social_medias">
            ...
            <div className="summary">
              <p>Experienced Software Engineer skilled in developing front-end, modern client-side frameworks utilizing React+Redux. Seeking a position to bring an outside-of-the-box approach and exceptional ability to identify problems and create effective solutions that keep projects on track and under budget.</p>
            </div>
...
<div className="service_detail">
  ...
  <small>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea autem labore minus blanditiis perferendis ullam placeat odio aspernatur libero incidunt.</small>
</div>
    </div>
    <div className="service_box">
    <div className="service_icon">
    <img width="100" height="100" src="https://img.icons8.com/clouds/100/design.png" alt="design"/>
</div>
<div className="service_detail">
  ...
  <div className="full_image" id="fullImageBox">
                <div className="close_Full_Image_gallery">
                  ...
                  <i className='bx bx-message-rounded-x'   onClick={closeFullImage}></i>
                </div>
...
<i className='bx bx-chevrons-right bx-fade-right' ></i>
    ...
    <div className="gallery_box">
      ...
      <img src="https://img.freepik.com/free-photo/program-development-concept-young-indian-man-working-with-computer_231208-3642.jpg?t=st=1714406712~exp=1714410312~hmac=7df28363674ef94a44ee90f5d6f44f704f6fd384694b991be19947cc86fef107&w=900" alt="developer" onClick={(e) => openFullImage(e.target.src)}  />
      <img src="https://img.freepik.com/free-photo/indian-man-programmers-testing-application-security-developed_231208-3632.jpg?t=st=1714406790~exp=1714410390~hmac=2f3b4e6da9792d6ce0b6a6833beefc2ff07ff4247697e5b5e7df7da50c36e8fc&w=900" alt="dev" onClick={(e) => openFullImage(e.target.src)} />
      <img src="https://img.freepik.com/free-photo/person-front-computer-working-html_23-2150040428.jpg?t=st=1714406836~exp=1714410436~hmac=001a19a19ebe9f04400855ba28261db4106ba1a74065072fc82722288195e084&w=900" alt="dev" onClick={(e) => openFullImage(e.target.src)} />
      <img src="https://img.freepik.com/free-photo/modern-equipped-computer-lab_23-2149241224.jpg?t=st=1714406908~exp=1714410508~hmac=b9713141f1453caa78cc47a406e62711acd35985065e7eb16c602ea84b5a9533&w=900" alt="dev" onClick={(e) => openFullImage(e.target.src)} />
      <img src="https://img.freepik.com/free-photo/team-working-animation-project_23-2149269881.jpg?t=st=1714406935~exp=1714410535~hmac=01aaacf4e2c99ad6dabd2eb622888bee8017eeab9cf76285d4274f25c20e038a&w=900" alt="dev" onClick={(e) => openFullImage(e.target.src)} />
    </div>
  </div>
  </div>
  {/* Products */}
  ...
  <Slide
    ...
    <div className="product_box">
      <div className="product_img">
        <img src="https://img.freepik.com/free-photo/programming-background-with-person-working-with-codes-computer_23-2150010130.jpg?t=st=1714410932~exp=1714414532~hmac=3f096bb7b654389f447dc507954dd41f6f709a24f497668a2a652c18eca12f9e&w=900" alt="product" />
      </div>
    ...
    <div className="product_box">
      <div className="product_img">
        <img src="https://img.freepik.com/free-photo/it-engineer-working-with-his-pc_1098-21511.jpg?t=st=1714412969~exp=1714416569~hmac=79f40259567920d51a8f2dd2b41fb53f4f9dda0301e870824e0962a2578af70c&w=900" alt="product" />
      </div>
      <div className="product_detail">
        <div className="product_title">
    ...
    <div className="product_box">
      <div className="product_img">
        <img src="https://img.freepik.com/free-photo/young-man-using-discount-coupon-his-smartphone-some-online-shopping-laptop_662251-2177.jpg?t=st=1714413081~exp=1714416681~hmac=37ebc737549b42066b0fc192de48ac9a59311cff141de3bc7b2223083d9935d1&w=900" alt="product" />
      </div>
      <div className="product_detail">
        <div className="product_title">
    ...
    <div className="product_box">
      <div className="product_img">
        <img src="https://img.freepik.com/free-vector/landing-page-with-smartphone-web-site_23-2148340671.jpg?t=st=1714413253~exp=1714416853~hmac=1614085c4220866860ace1f586046f7dbe14ae78d4839e98c6a3846e585bd701&w=900" alt="product" />
      </div>
      <div className="product_detail">
        <div className="product_title">
  ...
  <AwesomeSlider>
    <div>
    <img src="https://img.freepik.com/free-photo/programming-background-collage_23-2149901791.jpg?t=st=1714413632~exp=1714417232~hmac=f8e3ca58911b724ef0c04ffa5092fc74138e9d56808fa23b1e970d16cfe37023&w=996" alt="blog" />
    </div>
    <div>
    <img src="https://img.freepik.com/free-photo/young-woman-attending-online-class_23-2148854933.jpg?t=st=1714413922~exp=1714417522~hmac=fbd80b5d2c055cf7de85b2c4349ebbaeaf54ad33f20e8dc5ccf00b5bee4df9bd&w=900" alt="blog" />
    </div>
    <div>
    <img src="https://img.freepik.com/free-photo/friends-attending-online-class-together_23-2148854909.jpg?t=st=1714415361~exp=1714418961~hmac=1cdaa4a6abf5fef505d97c2c491559f20e56cf9c223ad04fcdab6b82d4ad66b4&w=996" alt="blog" />
    </div>
    <div>
    <img src="https://img.freepik.com/free-photo/friends-attending-online-class-together_23-2148854908.jpg?t=st=1714415384~exp=1714418984~hmac=e08808bf1892da8c667a9328f249b5271d102c031ee3c95aa097c0c030e7b60c&w=900" alt="blog" />
    </div>
    </AwesomeSlider>
  </div>
  </div>
  ...
  <div className="inquiries_container5">
    ...
    <i class='bx bxs-message-dots' ></i>
       ...
       <div className="card8_box_12">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="#36d7ff" fill-opacity="1" d="M0,64L120,96C240,128,480,192,720,186.7C960,181,1200,107,1320,69.3L1440,32L1440,320L1320,320C1200,320,960,320,720,320C480,320,240,320,120,320L0,320Z"></path></svg>
